 ...
 * @author ruoyi
 */
public interface VpnDeptMapper
{
    /**
     * 查询部门管理数据
     *
     ...
     * @return 部门列表
     */
    public List<VpnDept> selectChildrenDeptById(Long deptId);
     ...
     * @return 结果
     */
    public int updateDeptChildren(@Param("depts") List<VpnDept> depts);
     ...
     * @return 结果
     */
    public int updateDeptSort(VpnDept dept);

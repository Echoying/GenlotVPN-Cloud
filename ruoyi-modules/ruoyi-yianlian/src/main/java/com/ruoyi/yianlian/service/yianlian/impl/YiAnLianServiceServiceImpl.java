...
public class YiAnLianServiceServiceImpl implements IYiAnLianServiceService
{
    ...
    @Override
    public YiAnLianServiceListResp getServiceList(YiAnLianServiceListRequest request)
    {
        ...
        try {
            return openApiClient.post(request.getAppId(), YiAnLianConstants.serviceListPath, request, YiAnLianServiceListResp.class);
        }
        catch (Exception e) {
    ...
    public Boolean delete(String appId, List<String> ids)
    {
        ...
        try {
            return openApiClient.post(appId, YiAnLianConstants.serviceDeletePath, ids, Boolean.class);
        }
        catch (Exception e) {

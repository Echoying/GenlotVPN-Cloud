...
(9,'ruoyi-yianlian-dev.yml','DEFAULT_GROUP','yianlian:\n  base-url: http://10.9.1.72:20203\n  app-id: 202604101324332042473790244559356000\n  app-secret: l7z032nu5ssttquxb080o64x33b09nvorbg4zrhf8m52x4ma0zz9c79lrpf92xbf\n  token-path: /enadmin/api/open/v1/token\n\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.ruoyi.yianlian.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n','3f6f48ef9096450c35cf9e1d2828b29e','2026-04-20 00:00:00','2026-04-20 00:00:00','nacos','0:0:0:0:0:0:0:1','','','易安联模块','null','null','yaml','',''),

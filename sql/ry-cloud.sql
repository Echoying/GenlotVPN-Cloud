...
CREATE TABLE `line_app` (
  ...
  `url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '线路URL',
...
(111, 'Sentinel控制台', 2, 3, 'http://10.9.2.177:8718', '', '', '', 0, 0, 'C', '0', '0', 'monitor:sentinel:list', 'sentinel', 'admin', '2026-04-23 07:51:21', '', NULL, '流量控制菜单'),
(112, 'Nacos控制台', 2, 4, 'http://10.9.2.177:8848/nacos', '', '', '', 0, 0, 'C', '0', '0', 'monitor:nacos:list', 'nacos', 'admin', '2026-04-23 07:51:21', '', NULL, '服务治理菜单'),
(113, 'Admin控制台', 2, 5, 'http://10.9.2.177:9100/login', '', '', '', 0, 0, 'C', '0', '0', 'monitor:server:list', 'server', 'admin', '2026-04-23 07:51:21', '', NULL, '服务监控菜单'),
...
(116, '系统接口', 3, 3, 'http://10.9.2.177:8080/swagger-ui/index.html', '', '', '', 0, 0, 'C', '0', '0', 'tool:swagger:list', 'swagger', 'admin', '2026-04-23 07:51:21', '', NULL, '系统接口菜单'),

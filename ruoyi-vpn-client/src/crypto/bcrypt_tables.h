...
inline constexpr uint32_t S_ORIG[1024] = {
...
inline constexpr uint32_t BF_CRYPT_CIPHERTEXT[6] = {
    0x4f727068U, 0x65616e42U, 0x65686f6cU, 0x64657253U, 0x63727944U, 0x6f756274U
};
